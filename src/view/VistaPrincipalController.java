...
//Controlador del menu de la vista principal.
public class VistaPrincipalController {

    //Referencia a la clase principal (declaro un objeto de tipo LibretaDirecciones)
    ...
    /*--> Para abrir y guardar confirmar si hay personas en datosPersona, si es asi, sacar un alert de confirmacion 
    (alert.alertType.confirmation) "(esta usted seguro de que quiere abrir un nuevo fichero"?)*/
